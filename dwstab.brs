...
print "The Tab"
DwsTabServer = createObject("roHttpServer", { port: 8008 } )
?DwsTabServer
?DwsTabServer.AddGetFromFile({ url_path: "/", content_type: "text/plain; charset=utf-8", filename: "hello.txt" })
?DwsTabServer.SetupDWSLink("Tab")
